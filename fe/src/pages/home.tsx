...
const Home: React.FC<HomeProps> = ({ items }) => {
    ...
    return (
        <>
            ...
            <hr ref={items[1].ref} className="my-10 w-full scroll-m-5" style={{ borderTop: "2px solid white" }} />
            ...
            <hr ref={items[2].ref} className="my-10 scroll-m-5" style={{ borderTop: "2px solid white" }} />
