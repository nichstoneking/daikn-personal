...
const Analytics: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="flex px-6 rounded-lg shadow-md font-monaspice">
        {/* Stats Column */}
        <div className="w-1/3 pr-4 flex flex-col items-center justify-evenly">
          <div className="flex flex-col items-center">
            <h3 className="text-md text-gray-700">Commits this Week</h3>
            <div className="text-xl text-blue-600 mb-1">77</div>
            <span className="text-xs text-green-600">12.5%</span>
          </div>
          <div className="flex flex-col items-center">
            <h3 className="text-md text-gray-700">Repo Views</h3>
