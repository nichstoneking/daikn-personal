  ...
  return (
    <>
      ...
      <p className="mt-4 font-monaspice text-sm text-start">
        this was something that i&apos;ve been wanting to do for a long time,
        and decided to just start it after i saw{" "}
        <a
      ...
      <p className="mt-4 font-monaspice text-sm text-end">
        i&apos;m currently inbetween a CS and CE degree, and building random
